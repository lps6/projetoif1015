              ...
              <v-row class="align-center">
                <v-col cols="12" class="p-0">
                  <div class="bank-content-wrapper pl-6 pr-6">
                    <label class="pl-3 pr-3 label-text-style"
                      >Saldo Disponível</label
                    >
                      ...
                      <v-row class="mb-4 mt-1">
                        <v-col cols="12" class="p-0 m-0">
                          <div class="bank-selected-wrapper">
                            <h3 style="color: #ffffff;">Conta Bancária</h3>
                            <div class="bank-info-wrapper d-flex align-center">
                              ...
                              <div class="bank-info-wrapper flex-grow-1">
