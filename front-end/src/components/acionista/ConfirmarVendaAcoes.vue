      ...
      <template v-slot:card-body-content>
        <v-row class="align-center">
          <v-col cols="12" class="p-0">
            <div class="bank-content-wrapper pl-6 pr-6 BAForm-style mt-2">
              <p class="m-0 pb-0 pt-0 confirm-style">
                Confirmar a venda de
                <span class="destaque-style">10 ações </span> do contrato
                <span class="destaque-style">CONT000111</span> por
                <span class="destaque-style">R$ 200,00?</span>
              </p>
            </div>
          </v-col>
          <v-row class="pr-5 pl-5 pt-3">
            <v-col
              cols="12"
              align="center"
              :class="
            ...
            >
              <v-col :cols="$mq === 'xs' ? '2' : '1'" class="pl-0 pr-0">
                <v-btn
                  ...
                  @click="backHandler()"
                >
                  <v-icon class="icon-style">close</v-icon>
                </v-btn>
              </v-col>
