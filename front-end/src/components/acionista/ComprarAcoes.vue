    ...
    <v-row :align="$mq === 'xs' ? 'flex-start' : 'center'">
      <v-col cols="12">
        <v-row align="center" justify="center">
          ...
          <MinutaContrato
            v-if="showMinuta"
            @accept="changeMinutaComprovanteHandler()"
            @back="changeComprarMinutaHandler()"
          ></MinutaContrato>
          <!-- Comprar Acoes -->
          <AuthCard
            :hasHeader="true"
            headerText="COMPRAR AÇÕES"
          ...
          >
            <template v-slot:card-body-content>
              <v-row class="align-center" v-if="!showComprovante">
                  ...
                  <div class="bank-content-wrapper pl-6 pr-6">
                    ...
                    >
                      <label class="label-text-style"
                        >Método para receber o pagamento</label
                      >
                      <v-select
                      ...
                      ></v-select>
                      <label class="label-text-style"
                        >Selecione o banco para transferência</label
                      >
                      <v-select
                  ...
                  >
                    ...
                    <v-col :cols="$mq === 'xs' ? '10' : '11'" class="">
                      <RoundedBtn
                        ...
                        bgColorIcon="#68A776"
                        class="btn-style"
                        @click="changeComprarMinutaHandler()"
                      ></RoundedBtn>
                    </v-col>
                  </v-col>
                </v-row>
                ...
                <v-col cols="12" class="p-0">
                  <div class="bank-content-wrapper pl-6 pr-6">
                    <v-form
                      ...
                      class="pl-3 pr-3 BAForm-style mt-4"
                    >
                      <div class="bank-info-wrapper d-flex align-center">
                        <div class="">
                          <img
                            :src="getImage('itau-logo.png')"
                            alt=""
                            class="bank-img"
                          />
                        </div>
                        <div class="bank-info-wrapper flex-grow-1 pb-4">
                          <p class="p-0 m-0 transfer-text-style pl-4 pb-3">
                            TRANSFERIR PARA:
                          </p>
                          <p class="p-0 m-0 bank-text-style pl-4">
                            ITAÚ UNIBANCO
                          </p>
                        </div>
                      </div>
                      <div class="mb-5">
                        <div class="d-flex align-center dados-bancarios">
                          <h2>Razão Social:</h2>
                          <p class="p-0 m-0">OIG CAPITAL LTDA</p>
                        </div>
                        <div class="d-flex align-center dados-bancarios">
                          <h2>CNPJ:</h2>
                          <p class="p-0 m-0">36.441.162/0001-02</p>
                        </div>
                        <div class="d-flex align-center dados-bancarios">
                          <h2>Conta Corrente:</h2>
                          <p class="p-0 m-0">802566</p>
                        </div>
                        <div class="d-flex align-center dados-bancarios">
                          <h2>Agência:</h2>
                          <p class="p-0 m-0">344</p>
                        </div>
                      </div>
                      ...
                      >
                        ...
                        <input
                          ...
                          type="file"
                          style="display: none;"
                          @change="onFileChange($event, 'profile_file_input')"
                        />
                      </div>
                    </v-form>
                  </div>
                  ...
                  >
                    ...
                    <v-col :cols="$mq === 'xs' ? '10' : '11'" class="">
                      <RoundedBtn
                        colorBtn="#393A47"
                        block
                        text="CONCLUIR E AGUARDAR O CONTRATO"
                        :offsetBtnIcon="offsetBtnIconShared"
                        :loading="loading"
                        btnIcon="check"
                        bgColorIcon="#68A776"
...
import MinutaContrato from "@/components/acionista/MinutaContrato";
...
export default {
  ...
  methods: {
    ...
    changeComprarMinutaHandler() {
      // this.$refs.BAForm.validate();
      this.showMinuta = !this.showMinuta;
      this.showComprovante = false;
    },
    changeMinutaComprovanteHandler() {
      this.showMinuta = false;
      this.showComprovante = !this.showComprovante;
    },
    back() {
      this.$router.go(-1);
    },
