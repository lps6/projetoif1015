          ...
          >
            <template v-slot:card-body-content>
              <v-row class="pr-1 pl-1 pb-0">
                ...
                <v-col cols="8" class="pl-1 pr-1 pt-2 pb-2">
                  <InfoRounded
                    text="DATA DE REJEIÇÃO"
                    infoSize="38px"
                    value="30/03/2020"
                    bgColor="#454B60"
                    textColor="#FFFFFF"
              ...
              <v-row class="pr-2 pl-2">
                <v-col cols="12" class="pr-2 pl-2 m-0">
                  <v-card class="mx-auto justificativa-style" outlined>
                    <v-list-item>
                      <v-list-item-content>
                        <v-list-item-title
                          class="headline d-flex justify-center align-center"
                          >JUSTIFICATIVA</v-list-item-title
                        >
                      </v-list-item-content>
                    </v-list-item>
